...
def redrawAll(app):
    if app.startScreen and not app.controlsPage:
        ...
        drawImage("img/controllerInformation.png", 0, 0, width=app.width, height=app.height)
        drawRect(-5, -5, 100, 100, border = "black", fill = "lightGray")
        drawImage("img/houseIcon.png", 0, 0, width=90, height=90)
...
def drawControllerScreen(app):
    ...
    drawImage("img/infoIcon.png", 0, 0, width=90, height=90)
